...
use crate::{audio::AudioPlayer, i18n::i18n, utils, window::Window};

// Use the values provided by the build script at compile time.
...
impl Application {
  ...
  fn show_about(&self) {
    ...
    let dialog = adw::AboutDialog::builder()
      ...
      .version(VERSION)
      .developers(vec!["Emmanuele Bassi", "Volodia Kraplich"])
      .copyright("© 2025 Emmanuele Bassi")
      .website("https://github.com/VolodiaKraplich/amberol/")
      .issue_url("https://github.com/VolodiaKraplich/amberol/issues")
